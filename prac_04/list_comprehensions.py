...
greater_nine_numbers = [number for number in numbers if number > 9]
# print(greater_nine_numbers)
...
lats_name = ",".join([name.split()[1] for name in full_names if len(name) > 11])
# print(lats_name)
